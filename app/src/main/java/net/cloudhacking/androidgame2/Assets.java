...
public class Assets {
    ...
    public static final SpriteAsset MINIMAL2        = new SpriteAsset("minimal_triangles.png", 16, 16);
    ...
    public static final SpriteAsset MOTHERSHIP3     = new SpriteAsset("mothership3.png");
