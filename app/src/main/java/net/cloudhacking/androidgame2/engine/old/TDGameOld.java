 ...
 */
public class TDGameOld extends LoggableActivity implements GLSurfaceView.Renderer, View.OnTouchListener {

    /**
     * Keep static instance
     */
    private static TDGameOld sInstance;
    public static TDGameOld getInstance() {
        return sInstance;
    }
